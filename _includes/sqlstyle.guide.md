...
These guidelines are designed to make SQL queries more readable and easy to be shared across team members.

We strongly suggest any SQL users within Petal start to implement this style.
